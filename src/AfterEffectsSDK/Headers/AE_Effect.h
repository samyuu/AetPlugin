...
#define PF_AE_PLUG_IN_VERSION				PF_AE161_PLUG_IN_VERSION	// auto-set by prep_codeline_for_release.py, adjust comment if manually edit is okay
#define PF_AE_PLUG_IN_SUBVERS				PF_AE161_PLUG_IN_SUBVERS	// auto-set by prep_codeline_for_release.py, adjust comment if manually edit is okay
