...
namespace AetPlugin
{
	...
	namespace
	{
		...
		void ImportLayerVideoKeyFrames(AEGP_SuiteHandler& suites, const Aet::Layer& layer, const Aet::LayerVideo& layerVideo, FrameToAETimeFunc frameToAETime)
		{
	...
	void AetImporter::ImportLayerVideo(const Aet::Layer& layer)
	{
		...
		ImportLayerVideoKeyFrames(suites, layer, *layer.LayerVideo, [this](frame_t f) { return FrameToAETime(f); });
	}
